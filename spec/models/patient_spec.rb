...
describe Patient do
  ...
  describe "#archived?" do
    subject(:archived?) { patient.archived?(organisation:) }
  ...
  describe "#not_archived?" do
    subject(:not_archived?) { patient.not_archived?(organisation:) }
    ...
    context "with notification of death" do
      ...
      context "when in an upcoming session" do
        ...
        it "archives the patient" do
          ...
          expect(archive_reason.organisation_id).to eq(session.organisation_id)
        end
      end
    end
