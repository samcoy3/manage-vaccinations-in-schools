...
class DraftConsent
  ...
  attribute :notify_parent_refusal, :boolean
  ...
  def wizard_steps
    [
      ...
      (:notify_parent_refusal if ask_notify_parent_refusal?),
  ...
  on_wizard_step :notify_parent_refusal, exact: true do
    validates :notify_parent_refusal, inclusion: { in: [true, false] }
  end
  ...
  def send_confirmation? = notify_parent_refusal != false
  ...
  def reset_unused_fields
    ...
    self.notify_parent_refusal = nil unless ask_notify_parent_refusal?
